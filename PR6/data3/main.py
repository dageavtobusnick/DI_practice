...
my_file = os.path.join(os.path.dirname(__file__), os.path.normpath('[3]flights.csv'))
res_file_df=os.path.join(os.path.dirname(__file__), os.path.normpath('df_3.csv'))
res_file_dtypes=os.path.join(os.path.dirname(__file__), os.path.normpath("dtypes_3.json"))
...
column_dtype = {
    ...
    'SCHEDULED_TIME': pd.StringDtype(),
    'ELAPSED_TIME': pd.StringDtype(),
    'AIR_TIME': pd.StringDtype(),
    'DISTANCE': pd.StringDtype(), 
    'TAXI_IN': pd.CategoricalDtype()
}
