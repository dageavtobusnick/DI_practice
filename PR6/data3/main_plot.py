...
res_file_vf_AIR_TIME_in_YEAR = os.path.join(os.path.dirname(__file__), os.path.normpath('AIR_TIME_in_YEAR.png'))
...
plot = sns.boxplot(data=dataset, x='DAY_OF_WEEK', y='AIR_TIME')
plot.get_figure().savefig(res_file_vf_AIR_TIME_in_YEAR)
