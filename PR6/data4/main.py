...
my_file = os.path.join(os.path.dirname(__file__), os.path.normpath('[4]vacancies.csv.gz'))
res_file_df=os.path.join(os.path.dirname(__file__), os.path.normpath('df_4.csv'))
res_file_dtypes=os.path.join(os.path.dirname(__file__), os.path.normpath("dtypes_4.json"))
